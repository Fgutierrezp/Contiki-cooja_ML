...
#     print('silhouette: ', round(metrics.silhouette_score(pp3, cluster,metric='sqeuclidean'),5))
#     print('Calinski Harabasz Score:',round(metrics.calinski_harabasz_score(pp3, cluster),5))
#     print('Davies Bouldin Score:', round(metrics.davies_bouldin_score(pp3, cluster),5))
...
# def data_frame(df,pp3):

#     data_prections = pd.concat([pp3,df['label'],df['tipo_ataque'],df['Trans_cluster'],df['cluster']], axis = 1)
#     return data_prections


# def save_csv(df,pp3, name_csv):
#     data_prections=data_frame(df,pp3)
#     data_prections.to_csv(name_csv, sep='\t')
#     return data_prections
